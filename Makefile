...
PACKAGE ?= helm-cloudnative-pg
XRD_DIR := apis/cloudnativepgs
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/cloudnativepgs/standard.yaml
...
EXAMPLES := \
    examples/cloudnativepgs/minimal.yaml:: \
    examples/cloudnativepgs/standard.yaml::
...
render\:%:
	@example="examples/cloudnativepgs/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
